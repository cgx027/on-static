...
function internalApiFactory(
    ...
    function getQuery(req){
        ...
        query.id = req.query.id || req.body.id;
        query.name = req.query.name || req.body.name;
        query.version = req.query.version || req.body.version;
        query.iso = req.query.iso || req.body.iso;
        query.status = req.query.status || req.body.status;
